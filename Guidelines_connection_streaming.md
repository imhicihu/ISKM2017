...
* Disable (temporarily) screen sharing during the streaming event.
* Disable (temporarily) any disk drive encryption schema, ie.:
     - FileVault (MacOSX)
     - Bitlocker (Windows)
     - LUKS (Linux)
...
###Troubleshooting 
* _Vide_ `[Mac-Linux-Windows procedures.md](https://bitbucket.org/imhicihu/iskm2017/src/d857fd5340e35930223def52b5cc40055741fc71/Mac-Linux-Windows%20procedures.md?at=master)`: checklist and solutions related to Adobe Flash Player on different operating systems.
